...
class_labels = ["Basophil", "Eosinophil", "Lymphocyte", "Monocyte","Neutrophil"]  # Update this based on your dataset
...
def predict():
    ...
    # Get prediction
    predicted_label, confidence = predict_skin_cancer(file_path)
